...
By default all file paths will be relative. `"lib/in/node_modules"` will become `"./lib/in/node_modules"`. If you don't want paths to be modified, add `forceRelative=false` to the loader's query string. This can also be useful for requiring a module aliased in your webpack config.
